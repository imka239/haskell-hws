...
-- | This is Module GeomTaskFast
-- The aim of this program is to make Fast realization of Geometry Points with seq
module GeomTaskFast
  ( -- | Type
    Point (..),
    -- | Functions
...
-- | Classic realization: two `Int!` representing x and y coordinates for speed hack
data Point = Point
  { x :: {-# UNPACK #-} !Int,
    y :: {-# UNPACK #-} !Int
  }
...
-- | Function to summarize perimter and doubleArea using crossPoint and dist. Using boost from $!
